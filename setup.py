...
PACKAGEDATA = {
    ...
    'package_dir': {'Console': 'Console',
                   },
    'packages': ['Console',
                ],
    'scripts': ['scripts/Console'],
}
...
_DATA_DIR = os.path.join('Console', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'Console': data_dirs}
